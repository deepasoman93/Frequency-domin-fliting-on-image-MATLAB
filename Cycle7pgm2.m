...
% a) Apply IFFT to recontstruct image in MATLAB.
...
%Reading an image
img1 =imread("C:\Users\KUTTUSA\Pictures\Matlab\images\dol.jpg");
img =rgb2gray(img1);
...
% IFFT is applied to reconstruct an image in MATLAB obtained.